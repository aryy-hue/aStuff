        ...
        <table id="myTable" lass="table table-striped" style="width:100%; ">
            ...
            while($d = mysqli_fetch_array($data)){
                ?>
                    ...
                    <td><a class="btn btn-outline-dark " href="usersDetail.php?id_user=<?php echo $d['id_user']; ?>">Edit</a> <a class="btn btn-dark" href="/aStuff/controllers/userDeleteController.php?id_user=<?php echo $d['id_user']; ?>">Delete</a></td>
                </tr>
            <?php }?>
            </tbody>
        </script>
        </table>
        <a class="btn btn-outline-dark " href="/aStuff/view/auth/register.php">Add User</a>
    </div>
